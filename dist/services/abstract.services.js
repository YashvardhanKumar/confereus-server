...
class AbstractServices {
    ...
    static addAbstract(confId, userId, eventId, paperName, abstract, paperLink) {
        return __awaiter(this, void 0, void 0, function* () {
            let ttl = (yield events_model_1.Event.findById(eventId)).endTime;
            let data = new abstract_model_1.Abstract({ conferenceId: confId, eventId, userId, paperLink, abstract, paperName, endAt: ttl });
