...
class ConferenceServices {
    ...
    static addConferences(subject, about, startTime, endTime, admin, id) {
        return __awaiter(this, void 0, void 0, function* () {
            let data = new conference_model_1.Conference({ subject, about, startTime, endTime, admin, creator: id });
            yield data.save();
