...
function editEvent(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let data = yield event_services_1.EventServices.editEvents(req.body.data, eventId);
            app_1.io.emit("events", yield event_services_1.EventServices.fetchEvents(req.params.confId));
            app_1.io.emit("events-edit", data);
            res.json({ status: true, data });
        }
        catch (error) {
            // // console.log(error);
...
function deleteEvent(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            app_1.io.emit("events", yield event_services_1.EventServices.fetchEvents(req.params.confId));
            app_1.io.emit("events-delete", data);
        }
        catch (error) {
            // // console.log(error);
            res.json({ status: false, message: "Something went wrong" });
