...
function addAbstract(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let data = yield abstract_services_1.AbstractServices.addAbstract(confId, id, eventId, paperName, abstract, paperLink, isApproved);
            app_1.io.emit("abstracts", yield abstract_services_1.AbstractServices.fetchAbstract(confId, null));
            app_1.io.emit("added-abstracts", data);
...
function editAbstract(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let data = yield abstract_services_1.AbstractServices.editAbstract(req, absId);
            app_1.io.emit("abstracts", yield abstract_services_1.AbstractServices.fetchAbstract(req.body.confId, null));
            app_1.io.emit("edited-abstracts", data);
            res.json({ status: true, data });
        }
        catch (error) {
            console.log(error);
...
function deleteAbstract(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            app_1.io.emit("abstracts", yield abstract_services_1.AbstractServices.fetchAbstract(req.body.confId, null));
            app_1.io.emit("deleted-abstracts", data);
        }
        catch (error) {
            console.log(error);
            res.json({ status: false, message: "Something went wrong" });
...
function approveAbstract(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const absId = req.params.absId;
        try {
            let data = abstract_services_1.AbstractServices.approveAbstract(req.body, absId);
            res.json({ status: true, data });
        }
        catch (error) {
            console.log(error);
